...
const CreateItem = () => {
   ...
   const saveDetails = () =>{
      ...
      try{
        ...
        setFields(true);
        setMsg("Required fields not empty ");
        setAlertStatus("danger");
        setTimeout(() => {
          setFields(false);
          setIsloading(false);
              ...
              gap-4'>
     {
          ...
          <div className='w-full py-2 border-b border-gray-300 flex items-center gap-2'>
            ...
            <input type="text" 
              ...
              className='w-full h-full text-lg bg-transparent  outline-none border-none placehoder:text-gray-300 
              text-textColor' />
          </div>
          ...
          <div className='group flex justify-center items-center flex-col 
                          border-2 border-dotted border-gray-300 w-full h-225
                             ...
                             <div className='relative h-full'>
                               ...
                               <button 
                                type='button'
                                 ...
                                 bg-red-300 text-xl cursor-pointer outline-none
          ...
          <div className='flex items-center w-full'>
            ...
            bg-green-500 px-12 py-2 rounded-lg text-lg
