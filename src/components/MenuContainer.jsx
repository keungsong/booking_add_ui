 ...
 <section className='w-full  my-6 'id='menu'>
      <div className='w-full flex flex-col items-center justify-center'>
         {/**  <p className='text-2xl font-semibold capitalize text-headingColor  relative
          ...
          duration-100 mr-auto'>Our Hot Dishes
         </p>*/}
          <div className='w-full flex items-center justify-start lg:justify-center gap-8 py-6  overflow-x-scroll scrollbar-none'>
            ...
            categories.map(category=>(
                ...
                whileTap={{scale:0.75}}
                key={category.id} 
                className={`group ${filter === category.urlParamName ? "bg-green-600":"bg-card"}  
                w-24 min-w-[94px] h-28 cursor-pointer rounded-lg drop-shadow-xl flex flex-col 
                gap-3 items-center justify-center hover:bg-green-600 `}
